...
export const HomeView = () => {
  ...
  return (
    <div className="max-w-5xl w-full mx-auto flex flex-col gap-y-6 py-2 px-4 lg:px-0">
      <div className="flex flex-col md:flex-row items-start md:items-center gap-y-4 justify-between">
        ...
        <div className="flex flex-col gap-y-1">
          {currentTier !== "platinum" && (
            <span className="text-sm font-bold">Want to Updrade?</span>
          )}
